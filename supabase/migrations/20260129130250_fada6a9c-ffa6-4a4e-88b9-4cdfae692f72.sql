-- Fix send_nexus_transfer to automatically credit bonus points immediately
...
BEGIN
  ...
  -- Create boost record (already claimed since we're crediting instantly)
  ...
  VALUES (
    ...
    true  -- Already claimed - bonus credited immediately
  );

  -- INSTANTLY credit bonus points equal to amount sent to the SENDER
  UPDATE user_points
  SET total_points = total_points + p_amount,
