...
-- Temporarily update the trigger to allow admin decreases via service role
-- First drop and recreate the function to allow service_role to decrease points
...
BEGIN
  ...
  -- CRITICAL: Allow service_role AND admins to decrease points
