...
// Mobile UI — all fully redesigned + wired to real data
  ...
  return (
    <>
      <Routes>
        ...
        {isNative ? (
          <>
            {/* ── NATIVE MOBILE — all wired to real data ── */}
            ...
            {/* These use existing pages with mobile padding */}
...
function AppWithSplash() {
  ...
  return (
    <>
      {isNative && !splashDone && <MobileSplash isAppReady={!loading} onFinish={handleSplashFinish}/>}
      <AppRoutes/>
    </>
  );
}
