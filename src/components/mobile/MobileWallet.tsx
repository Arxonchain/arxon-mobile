  ...
  return (
    <motion.div variants={stagger} initial="hidden" animate="show"
      ...
      <motion.div variants={fadeUp}
        ...
        {/* FIX BUG-07: Proper Coming Soon with details and subscribe button */}
        <motion.div variants={fadeUp} style={{width:'100%',marginTop:8}}>
          <div style={{borderRadius:20,padding:'20px',background:'hsl(215 25% 10%)',
            border:'1.5px solid hsl(38 55% 52%/0.25)',textAlign:'center',position:'relative',overflow:'hidden'}}>
            <div style={{display:'flex',alignItems:'center',justifyContent:'center',gap:8,marginBottom:10}}>
              <div style={{width:8,height:8,borderRadius:'50%',background:'hsl(38 55% 52%)',
                boxShadow:'0 0 10px hsl(38 55% 52%/0.7)',animation:'pulse 1.5s ease-in-out infinite'}}/>
