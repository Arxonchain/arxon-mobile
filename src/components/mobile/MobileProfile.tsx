...
import { Copy, Check, Shield, Bell, BookOpen, Settings, LogOut, ChevronRight, ChevronLeft, Users, Wallet, Camera } from 'lucide-react';
...
export default function MobileProfile() {
  ...
  // ── Avatar upload — saves immediately to DB ───────────────────────────
  const handleAvatarChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      // Save to DB immediately — no separate Save button needed
  ...
  return (
    <motion.div variants={stagger} initial="hidden" animate="show"
      ...
      <motion.div variants={fadeUp}
        ...
        <button onClick={()=>navigate('/notifications')} className="press"
          style={{width:40,height:40,borderRadius:14,background:'hsl(215 25% 11%)',
            border:'1px solid hsl(215 22% 18%)',display:'flex',alignItems:'center',
            justifyContent:'center',cursor:'pointer',position:'relative'}}>
          <Bell size={16} color="hsl(215 25% 52%)"/>
            ...
            <div style={{display:'flex',alignItems:'center',gap:18,marginBottom:24}}>
              ...
              <div style={{position:'relative',flexShrink:0}}>
                <div className="pulse-glow"
                  ...
                  <div style={{position:'absolute',inset:0,background:'hsl(225 30% 3%/0.5)',
                    ...
                    {uploading
                      ? <div style={{width:20,height:20,borderRadius:'50%',border:'2px solid hsl(215 35% 62%/0.3)',borderTopColor:'hsl(215 35% 62%)',animation:'spin 1s linear infinite'}}/>
              ...
              <div style={{flex:1,minWidth:0}}>
                ...
                <div style={{display:'flex',gap:7,marginTop:10,flexWrap:'wrap'}}>
                  {rank && <div style={{background:'hsl(38 55% 52%/0.1)',border:'1px solid hsl(38 55% 52%/0.25)',borderRadius:20,padding:'4px 10px'}}>
          ...
          <div key={i} className="glass-card press"
            ...
            <div style={{display:'flex',alignItems:'center',gap:12}}>
              <div style={{width:38,height:38,borderRadius:13,background:'hsl(215 25% 12%)',
                border:'1px solid hsl(215 22% 18%)',display:'flex',alignItems:'center',justifyContent:'center',flexShrink:0}}>
